...
class IemocapDataset(torch.utils.data.Dataset):
    ...
    def get_labels(self, file_name):
        ...
        valence = parsed_dict["Valence"]
        action = parsed_dict["Action"]
        dominance = parsed_dict["Dominance"]
...
if __name__ == '__main__':
    iemocap_64_noprep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                       ...
                                       padding='repeat',
                                       label_type='four')
    iemocap_64_prep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                     spectrogram_shape=64,
                                     spectrogram_type='melspec',
                                     preprocessing=True,
                                     augmentation=True,
                                     padding='repeat',
                                     label_type='four')
    iemocap_128_noprep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                        ...
                                        padding='repeat',
                                        label_type='four')
    iemocap_128_prep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                      spectrogram_shape=128,
                                      spectrogram_type='melspec',
                                      preprocessing=True,
                                      augmentation=True,
                                      padding='repeat',
                                      label_type='four')
    iemocap_256_noprep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                        ...
                                        padding='repeat',
                                        label_type='four')
    iemocap_256_prep = IemocapDataset(PATH_TO_PICKLE, IEMOCAP_PATH_TO_WAVS, 'IEMOCAP',
                                      spectrogram_shape=256,
                                      spectrogram_type='melspec',
                                      preprocessing=True,
                                      augmentation=True,
